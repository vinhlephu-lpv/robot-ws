...
// Ngưỡng Deadzone & Giới hạn gia tốc PWM (Tối thiểu 28 PWM để thắng ma sát tĩnh hộp số khi chạy 0.15 m/s)
#define MIN_PWM                 28        // 28: Ngưỡng PWM tối thiểu thắng ma sát hộp số (tương đương ~0.15 m/s)
